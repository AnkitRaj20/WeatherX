const banTimeout = setTimeout(ban, 4000);
...
function ban() {
  fetch(
   ...
   cloud_pct_bangalore.innerHTML = response.cloud_pct;
        ...
        sunset_bangalore.innerHTML = sunset_time;
        sunrise_bangalore.innerHTML = sunrise_time;
        temp_bangalore.innerHTML = response.min_temp;
